...
urlpatterns = [
    ...
    path('membresia-pro-athlete/<int:membresia_id>/', views.membresia_pro_athlete, name='membresia_pro_athlete'),    path('calendario-actividades/', views.calendario_actividades, name='calendario_actividades'),
